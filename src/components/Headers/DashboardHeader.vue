		...
		<a-layout-header>
			<a-row type="flex">
				...
				<a-col :span="24" :md="18" class="header-control">
					...
					<div v-if="displayName" class="btn-sign-in">
						<span class="mr-2">{{ displayName }}</span>
						<svg @click="LOGOUT" viewBox="0 0 16 16" width="20" height="20" focusable="false" role="img" aria-label="box arrow in right" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi-box-arrow-in-right mx-auto b-icon bi"><g data-v-41be6633=""><path fill-rule="evenodd" d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0v-2z"></path><path fill-rule="evenodd" d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"></path></g></svg>
					</div>
...
<script>
	...
	import { LOGIN_VIA_SOCIAL_MEDIA, LOGOUT } from '@/store/action-types';
	...
	export default ({
		...
		computed: {
			...
			...mapState('auth', ['user', 'isUserLoading']),
		},
		methods: {
			...mapActions('auth', [LOGIN_VIA_SOCIAL_MEDIA, LOGOUT]),
			resizeEventHandler(){
