<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="images/logo-ct-black.png" alt=""> <span>Everstake CMS</span></div>
			<hr>
...
<!--				</a-menu-item>-->
			...
			<div class="aside-footer">
				<div class="footer-box">
					...
					<a-button type="primary" href="https://docs.google.com/document/d/11DYnbXU-vxwWLaINW6exICOej2DovsU5468YqL89xC4/edit?usp=sharing" block target="_blank">
						DOCUMENTATION
					</a-button>
				</div>
			</div>
